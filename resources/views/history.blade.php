...
<div class="d-flex justify-content-center m-3 ">
    ...
    <a href="" class="text-decoration-none p-2 m-2 btn btn-outline-primary">verivikasi</a>
...
<div class="d-flex flex-wrap justify-content-center">
    @foreach ($Pembayaran as $bayar)
        <div class="col-sm-4 m-3 shadow">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Pembayaran {{ $bayar->product->name_product }}</h5>
                    <p class="card-text">Jumlah: {{ $bayar->product->harga }}</p>
